...
::: reaxkit.workflows.ferroelectrics.basal_plane_displacement_for_dipole_moment.dipole_workflow
    options:
...
Calculate local dipoles from a three-N basal reference plane.
...
| Flag | Required | Default | Help | Choices |
|---|---|---|---|---|
| `--output-dir` | No |  | Choose the dipole CSV directory. Example: --output-dir ./basal_dipoles, writes analysis tables there. |  |
