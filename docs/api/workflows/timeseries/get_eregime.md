...
# Get Eregime Workflow

::: reaxkit.workflows.timeseries.get_eregime
    options:
...
| `--field` | Yes |  | Eregime field name, such as field, field_zones, or field_dir. |  |
...
| `--eregime` | No | eregime.in | Electric-field regime input path. |  |
