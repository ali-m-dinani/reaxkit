...
::: reaxkit.workflows.timeseries.get_molecular_totals
    options:
...
| `--quantities` | No | total_molecules, total_atoms, total_molecular_mass |  | total_molecules, total_atoms, total_molecular_mass |
