...
register_analysis_command("force_field_data", module_path="reaxkit.workflows.force_field_workflow")
register_analysis_command("force_field_optimization", module_path="reaxkit.workflows.force_field_workflow")
register_analysis_command("structure_summary_data", module_path="reaxkit.workflows.force_field_workflow")
...
register_analysis_command("parameter_optimization_tornado", module_path="reaxkit.workflows.force_field_workflow")
register_analysis_command("force_field_optimization_report", module_path="reaxkit.workflows.force_field_workflow")
register_analysis_command(
