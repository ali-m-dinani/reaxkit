...
register_generator("detect-isomer-representatives", module_path="reaxkit.workflows.file_tools.isomer_workflow")
register_generator("detect_isomer_representatives", module_path="reaxkit.workflows.file_tools.isomer_workflow")
register_generator("detect-isomers", module_path="reaxkit.workflows.file_tools.isomer_workflow")
register_generator("detect_isomers", module_path="reaxkit.workflows.file_tools.isomer_workflow")
register_generator("create-jaguar-isomer-jobs", module_path="reaxkit.workflows.file_tools.jaguar_isomer_workflow")
register_generator("create_jaguar_isomer_jobs", module_path="reaxkit.workflows.file_tools.jaguar_isomer_workflow")
register_generator("make-jaguar-isomer-jobs", module_path="reaxkit.workflows.file_tools.jaguar_isomer_workflow")
register_generator("make_jaguar_isomer_jobs", module_path="reaxkit.workflows.file_tools.jaguar_isomer_workflow")
register_generator("create-isomer-trainset", module_path="reaxkit.workflows.file_tools.isomer_trainset_workflow")
register_generator("create_isomer_trainset", module_path="reaxkit.workflows.file_tools.isomer_trainset_workflow")
register_generator("make-isomer-trainset", module_path="reaxkit.workflows.file_tools.isomer_trainset_workflow")
register_generator("make_isomer_trainset", module_path="reaxkit.workflows.file_tools.isomer_trainset_workflow")
...
register_generator("get-optimized-force-field-fort83", module_path="reaxkit.workflows.file_tools.fort83_workflow")
register_generator("get-optimized-ffield-fort83", module_path="reaxkit.workflows.file_tools.fort83_workflow")
