...
PRIORITY_TASK_MANIFEST: tuple[dict[str, Any], ...] = (
    ...
    {"command": "get-basal-plane-displacement-dipole", "module": "reaxkit.analysis.ferroelectrics.basal_plane_displacement_for_dipole_moment.dipole", "class": "BasalPlaneDipoleTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-basal-plane-displacement-local-polarization", "module": "reaxkit.analysis.ferroelectrics.basal_plane_displacement_for_dipole_moment.local_polarization", "class": "BasalPlaneLocalPolarizationTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-basal-plane-displacement-polarization", "module": "reaxkit.analysis.ferroelectrics.basal_plane_displacement_for_dipole_moment.polarization", "class": "BasalPlanePolarizationTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    ...
    {"command": "get-wurtzite-neighbors", "module": "reaxkit.analysis.ferroelectrics.four_folded_wurtzite.neighbors", "class": "WurtziteNeighborTask", "shape": "independent_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-wurtzite-polarity", "module": "reaxkit.analysis.ferroelectrics.four_folded_wurtzite.polarity", "class": "WurtzitePolarityTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "write-trajectory-with-polarity", "module": "reaxkit.analysis.ferroelectrics.four_folded_wurtzite.trajectory", "class": "PolarityExtendedXYZTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-hbn-reference-local-polarization", "module": "reaxkit.analysis.ferroelectrics.hbn_reference.local_polarization", "class": "HBNReferenceLocalPolarizationTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-hbn-reference-polarization", "module": "reaxkit.analysis.ferroelectrics.hbn_reference.polarization", "class": "HBNReferencePolarizationTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    ...
    {"command": "get-three-folded-wurtzite-neighbors", "module": "reaxkit.analysis.ferroelectrics.three_folded_wurtzite.neighbors", "class": "WurtziteNeighborTask", "shape": "independent_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-three-folded-wurtzite-polarity", "module": "reaxkit.analysis.ferroelectrics.three_folded_wurtzite.polarity", "class": "WurtzitePolarityTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "get-three-folded-wurtzite-polarization", "module": "reaxkit.analysis.ferroelectrics.three_folded_wurtzite.polarization", "class": "BinnedPolarizationTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
    {"command": "write-three-folded-trajectory-with-polarity", "module": "reaxkit.analysis.ferroelectrics.three_folded_wurtzite.trajectory", "class": "PolarityExtendedXYZTask", "shape": "reference_frame_map", "thread_safe": True, "status": "migrated_shared_pipeline"},
)
