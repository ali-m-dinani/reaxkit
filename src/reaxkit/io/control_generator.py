# reaxkit/generators/control_generator.py
...
def write_control_template(out_path: Union[str, Path] = "control") -> Path:
    """
    Write the default ReaxFF 'control' template (all sections + default values)
    with the exact spacing/alignment provided.

    Parameters
    ----------
    out_path : str | Path
        Output file path (default: "control").
