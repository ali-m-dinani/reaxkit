...
def build_parser(parser: argparse.ArgumentParser, *, command: str) -> argparse.ArgumentParser:
    ...
    parser.description = (
        ...
        "[Note] Worth mentioning that eregime.in can have a maximum of 100 entry lines. So, if you are working with "
        "a relatively long eregime profile, you may need to decrease the number of sampled points, or "
        "run multiple simulations using restart files.\n\n"
