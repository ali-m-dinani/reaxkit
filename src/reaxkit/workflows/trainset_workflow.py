...
from reaxkit.io.trainset_generator import (
...
# ----------------------------------------------------------------------
def gen_settings_task(args: argparse.Namespace) -> int:
    """
...
def register_tasks(subparsers: argparse._SubParsersAction) -> None:
    ...
    p_gens.set_defaults(_run=gen_settings_task)
    ...
    p_gen.set_defaults(_run=generate_task)