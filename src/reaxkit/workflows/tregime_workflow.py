"""a workflow module for quick generating sample tregime.in files"""
from __future__ import annotations

import argparse
from pathlib import Path

from reaxkit.io.tregime_generator import write_sample_tregime
...
def register_tasks(subparsers: argparse._SubParsersAction) -> None:
    ...
    gen.set_defaults(_run=task_generate)
